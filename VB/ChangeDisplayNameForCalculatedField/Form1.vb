...
Namespace ChangeDisplayNameForCalculatedField
	Partial Public Class Form1
		...
		Private Sub rep_DesignerLoaded(ByVal sender As Object, ByVal e As DesignerLoadedEventArgs)
            Dim svc As ITypeDescriptorFilterService = _
                CType(e.DesignerHost.GetService(GetType(ITypeDescriptorFilterService)), ITypeDescriptorFilterService)
	...
	Friend Class CustomTypeDescriptorFilterService
        ...
        Private Function FilterAttributes(ByVal component As IComponent, ByVal attributes As IDictionary) _
            As Boolean Implements ITypeDescriptorFilterService.FilterAttributes
            Return svc.FilterAttributes(component, attributes)
        End Function
        Private Function FilterEvents(ByVal component As IComponent, ByVal events As IDictionary) _
            As Boolean Implements ITypeDescriptorFilterService.FilterEvents
            Return svc.FilterEvents(component, events)
        End Function
        Private Function FilterProperties(ByVal component As IComponent, ByVal properties As IDictionary) _
            As Boolean Implements ITypeDescriptorFilterService.FilterProperties
            ...
            If TypeOf component Is CalculatedField Then
                ...
                properties("DisplayName") = TypeDescriptor.CreateProperty(GetType(CalculatedField), _
                    CType(properties("DisplayName"), PropertyDescriptor), attributes)
            End If
            Return result
        End Function
		#End Region
